> **Attribution**: The recipes in this project are **based on** [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory)'s native `examples` folder. We extend upon that foundation with default finetuning recipes tailored for the llama-factory-dock Docker adapter.
