> **致謝說明**：本專案的 recipes 以 [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) 原生的 `examples` 資料夾為基底，在此之上提供適用於 llama-factory-dock Docker adapter 的預設 finetuning recipes。
